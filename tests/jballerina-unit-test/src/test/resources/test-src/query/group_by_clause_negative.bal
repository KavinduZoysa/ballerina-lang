...
function testGroupbyExpressionAndSelectWithNonGroupingKeysNegative9() {
    var input = [{name: "Saman", price1: 11, price2: 23}, 
                    {name: "Saman", price1: 12, price2: 24}, 
                    {name: "Kamal", price1: 13, price2: 25},
                    {name: "Amal", price1: 14, price2: 26}];
...
function testGroupbyExpressionAndSelectWithNonGroupingKeysNegative10() {
    var input = [{name: "Saman", price1: 11, price2: 23}, 
                    {name: "Saman", price1: 12, price2: 24}, 
                    {name: "Kamal", price1: 13, price2: 25},
                    {name: "Amal", price1: 14, price2: 26}];
